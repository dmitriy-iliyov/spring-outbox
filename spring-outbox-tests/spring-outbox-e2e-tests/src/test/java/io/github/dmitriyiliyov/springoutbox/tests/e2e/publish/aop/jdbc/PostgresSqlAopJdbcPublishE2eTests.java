package io.github.dmitriyiliyov.springoutbox.tests.e2e.publish.aop.jdbc;
...
public class PostgresSqlAopJdbcPublishE2eTests extends BasePostgresSqlIntegrationTests {
    ...
    public PostgresSqlAopJdbcPublishE2eTests(
            @Qualifier("postgresAopJdbcBusinessService") AopBusinessService service,
