...
import io.github.dmitriyiliyov.springoutbox.config.OutboxProperties.StuckEventRecoveryProperties;
...
public class OutboxPropertiesStuckEventRecoveryPropertiesUnitTests {

    @Test
    @DisplayName("UT default constructor should assign default values")
    public void constructor_default_shouldAssignDefaults() {
        // given + when
        StuckEventRecoveryProperties recovery = new StuckEventRecoveryProperties();
    ...
    public void constructor_nullParameters_shouldAssignDefaults() {
        // given + when
        StuckEventRecoveryProperties recovery = new StuckEventRecoveryProperties(null, null, null);
    ...
    public void constructor_negativeBatchSize_shouldUseDefault() {
        // given + when
        StuckEventRecoveryProperties recovery = new StuckEventRecoveryProperties(-10, Duration.ofSeconds(100), Duration.ofSeconds(200));
    ...
    public void constructor_validParameters_shouldAssignValues() {
        ...
        // when
        StuckEventRecoveryProperties recovery = new StuckEventRecoveryProperties(batchSize, initialDelay, fixedDelay);
    ...
    public void equalsAndHashCode_shouldCompareCorrectly() {
        // given
        StuckEventRecoveryProperties recovery1 = new StuckEventRecoveryProperties();
        StuckEventRecoveryProperties recovery2 = new StuckEventRecoveryProperties();
        StuckEventRecoveryProperties recovery3 = new StuckEventRecoveryProperties(50, Duration.ofSeconds(60), Duration.ofSeconds(120));
