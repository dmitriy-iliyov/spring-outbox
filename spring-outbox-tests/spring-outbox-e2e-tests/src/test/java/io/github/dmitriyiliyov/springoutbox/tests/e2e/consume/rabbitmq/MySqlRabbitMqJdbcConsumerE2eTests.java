...
import io.github.dmitriyiliyov.springoutbox.tests.e2e.consume.test_template.BaseMySqlE2eTests;
...
public class MySqlRabbitMqJdbcConsumerE2eTests extends BaseMySqlE2eTests {
    ...
    public MySqlRabbitMqJdbcConsumerE2eTests(
