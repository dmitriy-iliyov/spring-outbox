...
import io.github.dmitriyiliyov.springoutbox.core.e2e.BusinessEvent;
...
public class DefaultOutboxPublisherVerifier {
    ...
    public DefaultOutboxPublisherVerifier(BusinessService service, JdbcTemplate jdbcTemplate, IdExtractor idExtractor) {
