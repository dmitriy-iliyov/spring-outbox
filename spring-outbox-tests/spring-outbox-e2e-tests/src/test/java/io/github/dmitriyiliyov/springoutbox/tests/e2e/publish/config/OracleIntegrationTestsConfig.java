...
public class OracleIntegrationTestsConfig {
    ...
    @Bean
    public ManualBusinessService oracleManualJdbcBusinessService(OutboxPublisher publisher, JdbcTemplate jdbcTemplate) {
    ...
    @Bean
    public ManualBusinessService oracleManualJpaBusinessService(
    ...
    @Bean
    public AopBusinessService oracleAopJdbcBusinessService(
    ...
    @Bean
    public AopBusinessService oracleAopJpaBusinessService(@Qualifier("jpaBusinessRepositoryProxy") BusinessRepository repository) {
