...
public class PostgresSqlDefaultOutboxPublisherE2eTests extends BasePostgresSqlIntegrationTests {
    ...
    public PostgresSqlDefaultOutboxPublisherE2eTests(
            @Qualifier("postgresBusinessService") BusinessService service,
