...
import io.github.dmitriyiliyov.oncebox.core.publisher.dlq.DefaultOutboxDlqTransfer;
import io.github.dmitriyiliyov.oncebox.core.publisher.dlq.DefaultOutboxDlqTransferVerifier;
...
public class OracleDefaultOutboxDlqTransferConcurrentTests extends BaseOracleIntegrationTests {
    ...
    @Autowired
    OracleDefaultOutboxDlqTransferConcurrentTests(
            OracleOutboxRepository outboxRepository,
