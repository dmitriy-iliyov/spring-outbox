...
public class AopPublishIntegrationVerifier {
    ...
    public AopPublishIntegrationVerifier(AopBusinessService service, JdbcTemplate jdbcTemplate, IdExtractor idExtractor) {
