...
public class OutboxPropertiesBackoffPublisherPropertiesUnitTests {
    ...
    public void init_defaultConstructor_assignsDefaults() {
        // given
    ...
    public void init_enabledTrueWithNull_assignsDefaults() {
        // given
        BackoffProperties backoff = new BackoffProperties();
    ...
    public void init_enabledFalse_disablesBackoff() {
        // given
        BackoffProperties backoff = new BackoffProperties();
    ...
    public void init_enabledNull_assignsDefaults() {
        // given
        BackoffProperties backoff = new BackoffProperties();
    ...
    public void init_validDelayAndMultiplier_keepsValues() {
        // given
        BackoffProperties backoff = new BackoffProperties();
        backoff.setEnabled(true);
    ...
    public void init_multiplierLessThanOne_usesDefaultMultiplier() {
        // given
        BackoffProperties backoff = new BackoffProperties();
        backoff.setEnabled(true);
