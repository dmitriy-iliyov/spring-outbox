...
public class OracleAopJdbcPublishE2eTests extends BaseOracleIntegrationTests {
    ...
    public OracleAopJdbcPublishE2eTests(
            @Qualifier("oracleAopJdbcBusinessService") AopBusinessService service,
