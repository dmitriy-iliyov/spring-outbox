...
public class OutboxPropertiesCleanUpPropertiesUnitTests {
    ...
    public void initialize_enabledTrue_noParams_shouldUseDefaults() {
        ...
        assertEquals(Duration.ofHours(1), cleanup.getThreshold());
    ...
    public void initialize_enabledTrue_withValues_shouldAssignValues() {
        ...
        cleanup.setThreshold(Duration.ofMinutes(30));
        ...
        assertEquals(Duration.ofMinutes(30), cleanup.getThreshold());
    ...
    public void initialize_enabledFalse_shouldDisableAndIgnoreValues() {
        ...
        assertNull(cleanup.getThreshold());
