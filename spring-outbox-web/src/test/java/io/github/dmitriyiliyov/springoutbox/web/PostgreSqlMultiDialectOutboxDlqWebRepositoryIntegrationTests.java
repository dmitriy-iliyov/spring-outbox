...
import io.github.dmitriyiliyov.springoutbox.web.it.BasePostgresSqlIntegrationTests;
...
@Transactional
class PostgreSqlMultiDialectOutboxDlqWebRepositoryIntegrationTests extends BasePostgresSqlIntegrationTests {

    private final MultiDialectOutboxDlqWebRepositoryIntegrationTests delegate;

    public PostgreSqlMultiDialectOutboxDlqWebRepositoryIntegrationTests(
            @Qualifier("postgresOutboxDlqWebRepository") OutboxDlqWebRepository repository,
