...
import io.github.dmitriyiliyov.springoutbox.tests.e2e.consume.test_template.BasePostgresSqlE2eTests;
...
public class PostgresSqlRabbitMqJdbcConsumerE2eTests extends BasePostgresSqlE2eTests {
    ...
    public PostgresSqlRabbitMqJdbcConsumerE2eTests(
