...
import io.github.dmitriyiliyov.oncebox.dlq.api.MultiDialectOutboxDlqApiRepositoryVerifier;
...
@Transactional
class PostgreSqlAbstractOutboxDlqApiRepositoryIntegrationTests extends BaseDlqApiPostgresSqlIntegrationTests {
