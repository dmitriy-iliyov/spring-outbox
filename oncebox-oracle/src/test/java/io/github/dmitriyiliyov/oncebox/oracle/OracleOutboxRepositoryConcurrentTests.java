...
class OracleOutboxRepositoryConcurrentTests extends BaseOracleIntegrationTests {
    ...
    @Autowired
    OracleOutboxRepositoryConcurrentTests(@Qualifier("oracleOutboxRepository") OutboxRepository repository,
    ...
    void concurrentPollers_secondPollerGetsDisjointBatch() throws Exception {
        String eventType = "oracle-poller-" + UUID.randomUUID();
