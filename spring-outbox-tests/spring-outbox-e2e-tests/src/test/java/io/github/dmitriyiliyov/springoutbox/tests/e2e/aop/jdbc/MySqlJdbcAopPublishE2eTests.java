...
import io.github.dmitriyiliyov.springoutbox.tests.e2e.aop.BaseMySqlIntegrationTests;
...
public class MySqlJdbcAopPublishE2eTests extends BaseMySqlIntegrationTests {
    ...
    public MySqlJdbcAopPublishE2eTests(
            @Qualifier("mysqlJdbcBusinessService") BusinessService service,
