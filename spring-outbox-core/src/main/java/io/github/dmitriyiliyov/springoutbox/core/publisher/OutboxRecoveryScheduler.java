...
public final class OutboxRecoveryScheduler implements OutboxScheduler {
    ...
    public OutboxRecoveryScheduler(OutboxPublisherPropertiesHolder.StuckRecoveryPropertiesHolder properties, ScheduledExecutorService executor, OutboxManager manager) {
        ...
        executor.scheduleWithFixedDelay(
                () -> {
                    try {
                        ...
                        manager.recoverStuckBatch(properties.getMaxBatchProcessingTime(), properties.getBatchSize());
                    } catch (Exception e) {
