...
@Transactional
class MySqlMultiDialectOutboxDlqApiRepositoryIntegrationTests extends BaseMySqlIntegrationTests {

    private final MultiDialectOutboxDlqWebRepositoryIntegrationTests delegate;

    public MySqlMultiDialectOutboxDlqApiRepositoryIntegrationTests(
            @Qualifier("mysqlOutboxDlqWebRepository") OutboxDlqApiRepository repository,
