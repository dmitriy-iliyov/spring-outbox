...
public class MySqlAopJpaPublishE2eTests extends BaseMySqlIntegrationTests {
    ...
    public MySqlAopJpaPublishE2eTests(
            @Qualifier("mysqlAopJpaBusinessService") AopBusinessService service,
