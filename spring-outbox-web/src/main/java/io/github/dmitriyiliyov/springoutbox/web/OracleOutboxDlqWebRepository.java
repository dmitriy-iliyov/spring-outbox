...
public class OracleOutboxDlqWebRepository extends MultiDialectOutboxDlqWebRepository {

    public OracleOutboxDlqWebRepository(JdbcTemplate jdbcTemplate, SqlIdHelper idHelper, ResultSetMapper mapper) {
