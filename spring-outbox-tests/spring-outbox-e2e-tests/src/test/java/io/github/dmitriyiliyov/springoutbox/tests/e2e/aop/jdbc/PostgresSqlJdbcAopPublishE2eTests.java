...
import io.github.dmitriyiliyov.springoutbox.tests.e2e.aop.BasePostgresSqlIntegrationTests;
...
public class PostgresSqlJdbcAopPublishE2eTests extends BasePostgresSqlIntegrationTests {
    ...
    public PostgresSqlJdbcAopPublishE2eTests(
            @Qualifier("postgresJdbcBusinessService") BusinessService service,
