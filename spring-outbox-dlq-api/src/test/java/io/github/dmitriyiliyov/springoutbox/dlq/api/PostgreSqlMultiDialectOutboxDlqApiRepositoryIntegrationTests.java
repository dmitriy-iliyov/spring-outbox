...
@Transactional
class PostgreSqlMultiDialectOutboxDlqApiRepositoryIntegrationTests extends BasePostgresSqlIntegrationTests {

    private final MultiDialectOutboxDlqWebRepositoryIntegrationTests delegate;

    public PostgreSqlMultiDialectOutboxDlqApiRepositoryIntegrationTests(
