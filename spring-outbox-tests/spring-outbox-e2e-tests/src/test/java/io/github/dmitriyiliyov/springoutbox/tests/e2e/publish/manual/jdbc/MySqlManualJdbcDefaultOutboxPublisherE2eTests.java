...
public class MySqlManualJdbcDefaultOutboxPublisherE2eTests extends BaseMySqlIntegrationTests {
    ...
    public MySqlManualJdbcDefaultOutboxPublisherE2eTests(
            @Qualifier("mysqlManualJdbcBusinessService") ManualBusinessService service,
