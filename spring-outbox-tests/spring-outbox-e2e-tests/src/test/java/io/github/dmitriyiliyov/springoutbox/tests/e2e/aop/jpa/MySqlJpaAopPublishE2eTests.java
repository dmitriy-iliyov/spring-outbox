...
public class MySqlJpaAopPublishE2eTests extends BaseMySqlIntegrationTests {
    ...
    public MySqlJpaAopPublishE2eTests(
            @Qualifier("mysqlJpaBusinessService") BusinessService service,
