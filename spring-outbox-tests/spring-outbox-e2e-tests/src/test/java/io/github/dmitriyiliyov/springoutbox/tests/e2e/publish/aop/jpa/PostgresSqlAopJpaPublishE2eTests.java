package io.github.dmitriyiliyov.springoutbox.tests.e2e.publish.aop.jpa;
...
public class PostgresSqlAopJpaPublishE2eTests extends BasePostgresSqlIntegrationTests {
    ...
    public PostgresSqlAopJpaPublishE2eTests(
            @Qualifier("postgresAopJpaBusinessService") AopBusinessService service,
