...
public class DeterminateTrafficGenerator implements TrafficGenerator {
    ...
    public void generate(Operation operation) {
        try {
            if (operation.equals(Operation.CREATE) || managedIds.size() / 2 < batchSize) {
                ...
                List<Long> idsToUpdate = GeneratorUtils.generateIds(batchSize, managedIds);
                ...
                List<Long> idsToDelete = GeneratorUtils.generateIds(batchSize, managedIds);
