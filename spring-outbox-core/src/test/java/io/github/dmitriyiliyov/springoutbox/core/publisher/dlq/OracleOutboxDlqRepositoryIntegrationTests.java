...
class OracleOutboxDlqRepositoryIntegrationTests extends BaseOracleIntegrationTests {
    ...
    public OracleOutboxDlqRepositoryIntegrationTests(@Qualifier("oracleOutboxDlqRepository") OutboxDlqRepository repository) {
    ...
    void findBatchByStatus_oraclePagination_correctPageSizes() {
        ...
        List<OutboxDlqEvent> page1 = repository.findBatchByStatus(DlqStatus.MOVED, 1, 3);
        List<OutboxDlqEvent> page2 = repository.findBatchByStatus(DlqStatus.MOVED, 2, 3);
        List<OutboxDlqEvent> page3 = repository.findBatchByStatus(DlqStatus.MOVED, 3, 3);
