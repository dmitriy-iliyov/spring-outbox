...
public class KafkaJdbcConsumerIntegrationTests extends BaseKafkaIntegrationTests {
    ...
    public KafkaJdbcConsumerIntegrationTests(
            @Qualifier("testKafkaTemplate") KafkaTemplate<String, Object> testKafkaTemplate,
