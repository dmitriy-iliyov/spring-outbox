...
class PostgreSqlOutboxDlqRepositoryConcurrentTests extends BasePostgresSqlIntegrationTests {
    ...
    @Autowired
    PostgreSqlOutboxDlqRepositoryConcurrentTests(@Qualifier("postgresOutboxDlqRepository") OutboxDlqRepository repository,
        ...
        jdbcTemplate.batchUpdate(
                ...
                new java.util.AbstractList<Object[]>() {
                    ...
                    public Object[] get(int index) {
                        ...
                        return new Object[]{UUID.randomUUID(), ts, ts, ts, ts};
                    }
