...
public class OracleDefaultOutboxDlqTransferConcurrentIntegrationTests extends BaseOracleIntegrationTests {

    private final DefaultOutboxDlqTransferVerifier verifier;

    @Autowired
    OracleDefaultOutboxDlqTransferConcurrentIntegrationTests(
