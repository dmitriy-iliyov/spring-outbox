...
import io.github.dmitriyiliyov.springoutbox.tests.e2e.consume.config.containers.RabbitMqTestContainerSingleton;
import io.github.dmitriyiliyov.springoutbox.tests.e2e.consume.rabbitmq.RabbitMqConsumerBusinessService;
import io.github.dmitriyiliyov.springoutbox.tests.e2e.consume.rabbitmq.RabbitMqConsumerFaultyBusinessService;
...
@TestConfiguration
@Profile("consume-e2e")
public class RabbitMqE2eTestsConfig {
