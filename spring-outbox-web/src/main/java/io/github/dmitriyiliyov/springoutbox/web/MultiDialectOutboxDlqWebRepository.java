...
public class MultiDialectOutboxDlqWebRepository implements OutboxDlqWebRepository {

    protected final JdbcTemplate jdbcTemplate;
    protected final SqlIdHelper idHelper;
    protected final ResultSetMapper mapper;

    public MultiDialectOutboxDlqWebRepository(JdbcTemplate jdbcTemplate, SqlIdHelper idHelper, ResultSetMapper mapper) {
