...
import io.github.dmitriyiliyov.oncebox.metrics.publisher.dlq.OutboxDlqManagerMetricsDecorator;
import io.github.dmitriyiliyov.oncebox.metrics.publisher.dlq.OutboxDlqMetrics;
import io.github.dmitriyiliyov.oncebox.metrics.publisher.dlq.OutboxDlqMetricsRepository;
import io.github.dmitriyiliyov.oncebox.metrics.publisher.dlq.OutboxDlqMetricsService;
    ...
    private ApplicationContextRunner getBaseContextRunner() {
        return new ApplicationContextRunner()
                ...
                .withPropertyValues(
                        ...
                        "oncebox.tables.auto-create=true",
    ...
    public void shouldLoadFullConfiguration_whenAllFeaturesEnabled() {
        getBaseContextRunner()
                .withPropertyValues(
                        "oncebox.publisher.metrics.enabled=true",
                        "oncebox.publisher.metrics.gauge.enabled=true",
                        "oncebox.publisher.metrics.gauge.cache.enabled=true",
